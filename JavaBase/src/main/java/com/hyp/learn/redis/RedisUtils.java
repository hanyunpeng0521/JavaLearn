...
public class RedisUtils {
    ...
    private RedisUtils() {
        if (pool == null) {
            SysConfigUtil configUtil = null;
            try {
                configUtil = SysConfigUtil.getSysConfigUtil("redis.properties");
            } catch (Exception e) {
                e.printStackTrace();
            }
            String ip = configUtil.getString("redis.host");
            Integer port = configUtil.getInt("redis.port");
            String password = configUtil.getString("redis.password");
            JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();
            jedisPoolConfig.setMaxTotal(configUtil.getInt("redis.maxTotal"));
            jedisPoolConfig.setMaxIdle(configUtil.getInt("redis.maxIdle"));
            jedisPoolConfig.setMaxWaitMillis(configUtil.getLong("redis.maxWaitMillis"));
            jedisPoolConfig.setTestOnBorrow(configUtil.getBoolean("redis.testOnBorrow"));
    ...
    public Object eval(String s, int c, String... args) {
        return getJedis().eval(s, c, args);
    }
